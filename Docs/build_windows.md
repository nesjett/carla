...
!!! Important
    To execute the "make" commands below, you MUST use the Visual Stucio 2017 native console x64 WITH administrator mode, otherwise you may be getting permission errors.
